...
// 			s, _ := NewWithConfig([]string{"foo", "bar"}, Config{MultiIndex: []interface{}{[]string{"A", "B"}, []int{1, 2}}})
// 			got, err := s.Insert(tt.args.pos, tt.args.val, tt.args.idx)
// 			if (err != nil) != tt.want.err {
// 				t.Errorf("s.Insert() error = %v, want %v", err, tt.want.err)
// 				return
// 			}
// 			want, _ := NewWithConfig(tt.want.values, Config{MultiIndex: tt.want.multiindex})
// 			if !Equal(got, want) {
...
// 		want want
// 	}{
// 		{args{"baz", []interface{}{"C", 3}},
// 			want{[]string{"foo", "bar", "baz"}, []interface{}{[]string{"A", "B", "C"}, []int{1, 2, 3}}}},
// 	}
// 	for _, tt := range tests {
// 		s, _ := NewWithConfig([]string{"foo", "bar"}, Config{MultiIndex: []interface{}{[]string{"A", "B"}, []int{1, 2}}})
// 		got := s.Append(tt.args.val, tt.args.idx)
// 		want, _ := NewWithConfig(tt.want.values, Config{MultiIndex: tt.want.multiindex})
// 		if !Equal(got, want) {
// 			t.Errorf("s.insert() returned %v, want %v", s, want)
// 		}
